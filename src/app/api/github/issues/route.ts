...
import { fetchIssues, getGitHubAccessToken } from '@/lib/github';
import type { GitHubIssueState } from '@/types/github';
 ...
 * Query params: owner, repo, state?, per_page?, page?, labels?, sort?, direction?
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const validatedParams = issuesQuerySchema.parse(queryParams);
    ...
    const issues = await fetchIssues(
      ...
      {
        state: validatedParams.state as GitHubIssueState,
