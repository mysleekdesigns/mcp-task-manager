...
function Sidebar({ className, isOpen = false, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-50 flex h-screen w-60 flex-col border-r border-sidebar-border bg-sidebar transition-all duration-300",
          // Desktop: always visible with normal width
      ...
      <div className="border-t border-sidebar-border p-4">
        <Button
          ...
          className="w-full gap-2 bg-sidebar-primary hover:bg-sidebar-primary/90 text-slate-900"
        >
